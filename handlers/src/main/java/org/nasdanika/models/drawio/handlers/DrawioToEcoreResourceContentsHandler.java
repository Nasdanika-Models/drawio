...
public class DrawioToEcoreResourceContentsHandler implements ResourceContentsHandler<EPackage[]> {
	...
	public DrawioToEcoreResourceContentsHandler(Resource resource, ResourceContentsHandler<Document> docuentHandler) {
