package org.nasdanika.models.drawio.handlers;
...
public class DrawioToEcoreArrayResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<EObject[]>> {
	...
	protected ResourceContentsHandler<EObject[]> createHandler(Resource resource, ResourceContentsHandler<Document> dh) {
		return new DrawioToEcoreResourceContentsHandler(resource, dh).adaptToEObjectArrayContentsHandler();
	}
